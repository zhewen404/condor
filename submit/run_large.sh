...
echo "cd gem5"
cd gem5
echo "my_scripts/fs/ckpt_resume.sh 64 ${bench} ${sim} 0"
my_scripts/fs/ckpt_resume.sh 64 ${bench} ${sim} 0
echo "cd .."
cd ..

timestamp=$(date +%Y%m%d-"%H%M%S")
echo "tar -czf ${bench}_${sim}_64_0_$timestamp.tar gem5/my_STATS/${bench}_${sim}_64_0"
tar -czf ${bench}_${sim}_64_0_$timestamp.tar gem5/my_STATS/${bench}_${sim}_64_0
